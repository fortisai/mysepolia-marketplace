...
function App() {
    ...
    useEffect(() => {
        function initNFTContract() {
            ...
            setNFTContract(new Contract(REACT_APP_CONTRACT_ADDRESS, contractABI.abi, signer));
        }
        initNFTContract();
    }, [account]);
    ...
    async function handleMint(tokenURI) {
        setIsMinting(true);
        try {
            const options = { value: ethers.utils.parseEther("0.01"), gasLimit: 30000000 };
